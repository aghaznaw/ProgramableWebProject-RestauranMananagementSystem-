...
INSERT INTO `vendor` (vendorId,Name,address,email,phont,restaurantId) VALUES (1,'Prisma','Linnanma, Oulu, Finland','prisma.linnan@prisma.fi','04332255','4'),
 (2,'prisma','Jyvasentie 1, Jyvaskyla, Finland','prisma.jyvas@prisma.fi','044665555','2'),
 (3,'lidl','Salmirannantie 8, Jyvaskyla, Finland','lidl.jvas33@lidl.fi','044555544','3'),
 (4,'K SuperMareket','Linnanma, Oulu, Finland','ksupermarket@ksupermarket.fi','0455665555','1'),
 (5,'Presma','Salmirannantie 8, Jyvaskyla, Finland','presma','04665588665','3');
CREATE TABLE `user` (
...
INSERT INTO `item` (itemId,itemName,description,restaurantId) VALUES (1,'coca cola','soft drink','1'),
